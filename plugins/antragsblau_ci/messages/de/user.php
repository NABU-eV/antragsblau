...
return [
    ...
    'recover_mail_title'        => 'Antragsblau: Passwort-Wiederherstellung',
    ...
    'del_explanation'           => 'Hier kannst du diesen Zugang von Antragsblau löschen. Du erhältst keine E-Mail-Benachrichtigungen mehr,
    ...
    'noti_new_comment_title'    => '[Antragsblau] Neuer Kommentar zu %TITLE%',
    'noti_new_comment_body'     => "Es wurde ein neuer Kommentar zu %TITLE% geschrieben:\n%LINK%",
    'acc_grant_email_title'     => 'Antragsblau-Zugriff',
    ...
    'acc_request_noti_subject' => 'Anfrage: Zugriff auf Antragsblau-Seite',
    ...
    'create_emailconfirm_title' => 'Anmeldung bei Antragsblau',
    'create_emailconfirm_msg'   =>
        "Hallo,\n\num deinen Antragsblau-Zugang zu aktivieren, klicke entweder auf folgenden Link:\n" .
        "%BEST_LINK%\n\n"
        . "...oder gib, wenn du auf Antragsblau danach gefragt wirst, folgenden Code ein: %CODE%\n\n"
    ...
    'no_noti_all'          => 'Alle Antragsblau-Benachrichtigungen abbestellen',
    ...
    'export_intro' => 'Hier kannst du alle personenbezogene Daten, die in Antragsblau über dich gespeichert sind, in einem maschinenlesbaren JSON-Format herunterladen.',
