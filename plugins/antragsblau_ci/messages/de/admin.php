...
return [
    ...
    'index_site_config'           => 'Konfiguration der Antragsblau-Installation',
...
<small class="conPrefixHide">Antragskürzel müssen zwar weiterhin angegeben werden, damit danach sortiert werden kann, werden aber nicht mehr angezeigt.</small>',
    ...
    'con_show_ad'             => '„Dein Antragsblau“ in der Sidebar anzeigen',
...
Die Benutzer*innenverwaltung unten kommt erst dann voll zur Geltung, wenn die Leserechte oder die Rechte zum Anlegen
 ...
 Anträge etc. stellen können sollen, kannst du das hiermit automatisch einstellen:',
    ...
    'siteacc_useraccounts'        => 'Standard-Antragsblau-Accounts <small>(alle mit gültiger E-Mail-Adresse)</small>',
...
wir haben dir soeben Zugang zu unserer Antragsblau-Seite eingerichtet, ' .
...
Falls sie noch keinen eigenen Zugang auf Antragsblau hatten, wird automatisch einer eingerichtet
und an der Stelle von <strong>%ACCOUNT%</strong> erscheinen die Zugangsdaten
(ansonsten verschwindet das %ACCOUNT% ersatzlos).<br>
<strong>%LINK%</strong> wird immer durch einen Link auf die Antragsblau-Seite ersetzt.',
...
Da <strong>kein E-Mail-Versand</strong> eingerichtet ist, musst du die <strong>Passwörter</strong> hier selbst erzeugen, im Klartext eingeben und selbst an die Nutzer*innen schicken.<br><br>' .
        'Aus <strong>Datenschutzgründen</strong> wäre empfehlenswerter, zunächst den E-Mail-Versand einzurichten, damit Antragsblau automatisch Passwörter erzeugen und direkt an die Nutzer*innen schicken kann.',
    ...
    'translating_hint'            => 'Auf dieser Seite können die Texte der Benutzeroberfläche von Antragsblau angepasst werden. Falls du eine komplett neue Sprache anlegen und allen anderen Nutzer*innen von Antragsblau bereit stellen willst, <a href="https://github.com/CatoTH">melde dich</a> einfach bei uns.<br><br>' .
    ...
    'php_version_hint_text'  => 'Auf diesem Server läuft noch PHP in der veralteten Version %CURR%. Zukünftige Versionen von Antragsblau sind damit nicht mehr kompatibel. Bitte aktualisiere bald.',
